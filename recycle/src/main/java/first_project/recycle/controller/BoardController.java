...
public class BoardController {
    ...
    public String boardList(
        ...
        BoardPageResponse result =
                boardService.getBoards(page, keyword, searchType, boardType, sort, memberId);
...
// 최신 공지 3개를 상단에 고정
        if (boardType == null
            ...
            List<BoardListResponse> notices = boardService.getRecentNotices();
    ...
    public String boardDetail(
        ...
        if (!viewedBoards.contains(boardId)) {
            ...
            // 증가된 조회수를 화면에도 바로 반영
            board = boardService.getBoardDetail(boardId);
        ...
        if (board.getBoardType() != BoardType.NOTICE) {
            ...
            // 해당 게시글의 댓글 목록
            model.addAttribute("comments", commentResult.getComments());
            model.addAttribute("commentPaging", commentResult.getPaging());
        }
        ...
        model.addAttribute("nextBoard", boardService.getNextBoard(boardId, board.getBoardType()));

        // 좋아요 수
        board.setLikeCount(boardLikeService.getLikeCount(boardId));

        // 로그인한 사용자의 좋아요 여부
        if (loginUser != null) {
            board.setLiked(boardLikeService.isLiked(boardId, loginUser.getMemberId()));
        }
    ...
    public String updateBoard(
        ...
        return redirectToDetail(boardId, page, keyword, searchType, listBoardType, sort, myPosts);
    }
    ...
    public String deleteBoard(
        ...
        return redirectToList(page, keyword, searchType, boardType, sort, myPosts);
    }
    ...
    public String deleteImage(
        ...
        return redirectToEdit(boardId, page, keyword, searchType, boardType, sort, myPosts);
    }
